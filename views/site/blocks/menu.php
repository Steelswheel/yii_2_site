    ...
    <header class="header purple-bg">
        <div class="container d-flex align-items-center justify-content-between">
            <div class="header-logo">
                <?= Url::current() !== '/' ? Html::a(Html::img('/img/logo-white.svg', ['alt' => 'logo', 'itemprop' => 'image']), '/', ['itemprop' => 'url']) : Html::img('/img/logo-white.svg', ['alt' => 'logo', 'itemprop' => 'image']) ?>
            </div>
            <div class="nav__mobile-menu">
                <a href="#" class="onShowMobileMenu d-flex align-items-center">
                    <div class="onShowMobileMenu__text">МЕНЮ</div>
                    <img src="/img/menu-icon.png" alt="mobile-menu-icon">
                </a>
            </div>
